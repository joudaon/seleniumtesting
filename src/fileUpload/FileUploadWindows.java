...
public class FileUploadWindows {
	...
	public void fileUpload() throws AWTException, InterruptedException {
		...
		driver.findElement(By.xpath("//div[text()='REDACTAR']")).click();
		driver.findElement(By.xpath("//div[@class='wO nr l1']//textarea")).sendKeys("email@gmail.com");
		...
		StringSelection ss = new StringSelection("C:\\Users\\Uda\\Desktop\\testfile.txt");
		...
		driver.findElement(By.xpath("//div[text()='Enviar']")).click();
	}
